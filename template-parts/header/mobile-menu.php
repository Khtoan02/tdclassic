    ...
    <div class="mobile-drawer">
        ...
        <div class="h-20 flex items-center justify-between px-6 border-b border-white/10 shrink-0">
            ...
            if ($custom_logo_id) {
                ...
                if ($logo) {
                    echo '<img src="' . esc_url($logo[0]) . '" alt="' . esc_attr(get_bloginfo('name')) . '" class="header-logo-mobile h-8 w-auto">';
                }
            } else {
        ...
        <div class="p-6 border-t border-white/10 bg-white/5 shrink-0">
            <a href="#"
                class="flex items-center justify-center w-full py-3 bg-white text-black font-bold uppercase tracking-widest text-xs mb-6">
                Tư vấn ngay
            </a>
